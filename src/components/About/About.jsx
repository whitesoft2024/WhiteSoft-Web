    ...
    <section id="about" className="about-whitesoft">
      <div className="container">
        ...
        <p>
          ...
          accommodate the brightest minds in the industry.
        </p>
        <p>
          With every step forward, we remain committed to fostering
          technological advancement, empowering businesses, and driving
          innovation.
        </p>
        ...
        <p>
          ...
          vibrant environment designed to inspire creativity and collaboration.
          Strategically located at KC Arcade, Kakkanad, our facility is equipped
          with modern amenities to ensure the best for our talented team and
          valued clients.
        </p>
        <p>
          We envision creating an inclusive space where the best talents can
        ...
        <ul>
          <li>
            To be a catalyst for technological and advertising excellence.
          </li>
          <li>
            To nurture local talent and connect it to global opportunities.
          </li>
          <li>
            To create a legacy of innovation and quality that redefines industry
            standards.
          </li>
        </ul>
        <p>
